...
class PEM_electrolyzer_LT:
    ...
    def external_power_supply(self):
        ...
        if self.input_dict["voltage_type"] == "constant":
            ...
            ) / (self.stack_input_voltage_DC * self.system_design())
    ...
    def cell_design(self):
        ...
        sigma = ((0.005139 * lambda_water_content) - 0.00326) * math.exp(
            1268 * ((1 / 303) - (1 / T_K))
        )  # Material thickness # material conductivity
        R_cell = delta / sigma
    ...
    def h2_production_rate(self):
        ...
        h2_produced_kg_hr = (
            h2_production_rate_g_s * 3.6 * 72.55 / 55.5
        )  ## TEMPORARY CORRECTION APPLIED FOR PEM EFFICIENCY to reach expected 55.5kwh/kg value
