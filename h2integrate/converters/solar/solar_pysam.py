...
class PYSAMSolarPlantPerformanceModel(SolarPerformanceBaseClass):
    ...
    def setup(self):
        ...
        self.add_output("capacity_AC", val=0.0, units="kW", desc="PV rated capacity in AC")
        self.add_output(
            "annual_energy",
            val=0.0,
            units="kW*h/year",
    ...
    def compute(self, inputs, outputs, discrete_inputs, discrete_outputs):
        ...
        self.system_model.value("system_capacity", inputs["capacity_DC"][0])
        ...
        outputs["capacity_AC"] = pv_capacity_kWdc / dc_ac_ratio
