...
class HydrogenIronReductionPlantPerformanceComponent(om.ExplicitComponent):
    def initialize(self):
    ...
    def setup(self):
        ...
        self.config = HydrogenIronReductionPerformanceConfig.from_dict(
    ...
    def format_coeff_df(self, coeff_df):
        ...
        coeff_df = coeff_df[coeff_df["Product"] == "h2_dri"]
