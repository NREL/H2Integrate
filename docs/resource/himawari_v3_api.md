...
| :--------- | :---------------: | :---------------: | :---------------: | :---------------: | :---------------: |
| `himwari7_solar_v3_api`  | 30, 60 min  | 4 km | 2011-2015  | Asia, Australia & Pacific | [Himawari 2011-15](https://developer.nrel.gov/docs/solar/nsrdb/himawari7-download/) |
| `himwari8_solar_v3_api`  | 10, 30, 60 min  | 2 km | 2016-2020  | Asia, Australia & Pacific | [Himawari 2016-2020](https://developer.nrel.gov/docs/solar/nsrdb/himawari-download/) |
| `himwari_tmy_solar_v3_api`  | 60 min  | 4 km | 2020, for tmy, tdy and tgy  | Asia, Australia & Pacific |  [Himawari TMY](https://developer.nrel.gov/docs/solar/nsrdb/himawari-tmy-download/) |


```{note}
For the himwari_tmy_solar_v3_api model, the resource_year should be specified as a string formatted as `tdy-2020` or `tgy-2020` or `tmy-2020`.
```
