...
```yaml
technology_interconnections: [
  ["wind_farm", "power_combiner", "electricity", "cable"],
  ["solar_farm", "power_combiner", "electricity", "cable"],
  ["power_combiner", "electrolyzer", "electricity", "cable"],
]
```
  ...
  power_splitter:
    performance_model:
      ...
      config:
        ...
        fraction_of_electricity_to_first_tech: 0.7  # for fraction mode
        # OR
        prescribed_electricity_to_first_tech: 500.0  # for prescribed mode
```
...
config:
  split_mode: "fraction"
  fraction_of_electricity_to_first_tech: 0.3  # 30% to first tech, 70% to second
```

- **Input parameter**: `fraction_of_electricity_to_first_tech` (0.0 to 1.0)
- **Behavior**:
...
config:
  ...
  prescribed_electricity_to_first_tech: 200.0  # 200 kW to first tech
```

- **Input parameter**: `prescribed_electricity_to_first_tech` (kW)
- **Behavior**:
...
- **Input**:
  ...
  - Mode-specific inputs: either `fraction_of_electricity_to_first_tech` or `prescribed_electricity_to_first_tech`
- **Outputs**:
