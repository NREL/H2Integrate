...
**General finance models** are not technology specific finance models. These models live in the `h2integrate/finances/` folder. These models are input the `driver_config`, `tech_config`, `plant_config`, `commodity_type`, and a `description` as the options.
